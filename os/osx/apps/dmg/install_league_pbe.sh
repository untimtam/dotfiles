...
# Dowload
declare -r NAME="League of Legends PBE"
declare -r URL="http://l3cdn.riotgames.com/PBE/League%20of%20Legends%20PBE.dmg"
# Dmg
declare -r VPATH="/Volumes/League of Legends PBE"
declare -r APP="League of Legends PBE.app"
